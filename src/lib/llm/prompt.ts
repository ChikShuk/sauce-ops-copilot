...
export function buildSystemPrompt(): string {
  return [
    ...
    "- issue: a short noun phrase naming the pattern, not a sentence. Sentence case —",
    "  capitalize the first word and any proper nouns, leave the rest lower case, and end",
    "  with no full stop.",
